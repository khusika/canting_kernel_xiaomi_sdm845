...
extern void exfat_time_fat2unix(struct exfat_sb_info *sbi, exfat_timespec_t *ts,
				DATE_TIME_T *tp);
extern void exfat_time_unix2fat(struct exfat_sb_info *sbi, exfat_timespec_t *ts,
				DATE_TIME_T *tp);
